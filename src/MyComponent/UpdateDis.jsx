...
class UpdateDis extends Component {
    constructor(props) {
        super(props)
    ...
    componentDidMount(){
        Service.getDistrictById(this.state.id).then((res) => {
            let district = res.data;
            this.setState({name: district.name, code:district.code, description: district.description, activeStatus: district.activeStatus});
        } );
    }
    ...
    updateDistrict = (e) => {
        ...
        Service.updateDistrict(district, this.state.id).then((res) => {
            ...
            <div className="row justify-content-center">
                <div className="col-12 col-sm-6 col-md-3">
                    <form className="form-card sign-up-form bg-light">
                        <h2 className="text-center">Update District Masters</h2>
                        ...
                        <div className="mb-3">
                            ...
                            <div className="fgroup">
                                <input type="text" className="form-control" name="name" placeholder="District Name" required="required" value = {this.state.name} onChange = {this.changeNameHandler} />
                                </div>
                            <div className="fgroup"><input type="text" className="form-control" name="code" placeholder="District Code"
                                ...
                                <div className="d-grid gap-2">
                                    <button type="submit" className="btn btn-secondary " onClick={this.updateDistrict} >Update</button>
                                </div>
